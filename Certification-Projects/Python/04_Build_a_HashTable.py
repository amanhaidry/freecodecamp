...
class HashTable:
    ...
    def add(self, key, value):
        ...
        # If the hash doesn't exist yet, create a nested dictionary
    ...
    def remove(self, key):
        ...
        # Check if the hash exists and then if the specific key exists within it
    ...
    def lookup(self, key):
        ...
        # Access the nested dictionary and return the value if it exists
