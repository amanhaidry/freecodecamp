...
# tests
print(Employee._base_salaries)

tony_stark = Employee("Tony Stark","senior")
print(tony_stark)
print(tony_stark.name)
tony_stark.name = "Iron Man"
print(tony_stark.salary)
tony_stark.salary = 1000000